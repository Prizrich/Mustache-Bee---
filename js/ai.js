// ===================================================================
// 1. БАЗА ДАННЫХ ИИ-ОТЗЫВОВ С ТЕХНИЧЕСКИМИ КЛЮЧАМИ (ДЛЯ СВЯЗКИ)
// ===================================================================
const REVIEWS_DB = {
    pepto: {
        authorName: "PETPO",
...
// ===================================================================
// 3. УМНЫЙ ИНТЕРПРЕТАТОР РЕЧИ И СЮЖЕТА
// ===================================================================
class AIDirector {
    static generateReviewText(slug, productName, isPositive, currentPrice) {
        // Ищем карточку персонажа по его английскому системному ID
    ...
    static getMailResponse(character, message) {
        ...
        // Перехват пасхалки-ругательства
